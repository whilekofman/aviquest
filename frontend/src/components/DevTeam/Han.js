        ...
        <div className="engineer-subcontainer">
            ...
            <div className="engineer-about-container">
                ...
                <div className="engineer-about-blurb">
                    <p className="engineer-blurb">Han served as teamlead and project flex, working on all aspects of AviQuest.  Han was our northstar and guiding light. Checkout Hans's <a href="https://www.hanchen.dev" target="_blank">portfolio</a> or contact him via <a href="mailto:hanmikechen@gmail.com">email!</a></p>
                </div>
